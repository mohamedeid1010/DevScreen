...
function commitCell(val: number) {
...
export const metadata: Metadata = { title: "Code Intelligence Vector" };
        ...
        <div className="flex flex-wrap items-start justify-between gap-5">
          <div className="space-y-3">
            ...
            <div className="flex flex-col gap-2 sm:flex-row">
              ...
              <Button asChild variant="outline" className="h-10 rounded-xl px-5 text-sm">
