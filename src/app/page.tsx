        ...
        <header className="flex items-center justify-between rounded-2xl border border-[#ffffff12] bg-[#111113] px-5 py-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-[#f2eae3]">Code Intelligence Platform</p>
            </div>
          </div>
          ...
          <section className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div className="space-y-8">
              ...
              <div className="animate-rise space-y-5 [animation-delay:60ms]">
                ...
                <p className="max-w-xl text-lg leading-8 text-[#a8a29e]">
                  DevScreen analyzes GitHub repositories with NLP, builds skill embeddings, and
                  matches candidates to roles using vector similarity — no self-reported data, no
                  keyword bingo.
                </p>
              </div>
            ...
            <div className="animate-rise space-y-4 [animation-delay:100ms]">
              <div className="grid grid-cols-2 gap-3">
                {stats.map((s) => (
                  <div key={s.label} className="rounded-2xl border border-[#ffffff0a] bg-[#111113] p-5">
                ...
                <div className="flex items-center gap-1">
                  {pipeline.map((p, i) => (
                    <div key={p.step} className="flex flex-1 items-center gap-1">
                      ...
                      {i < pipeline.length - 1 && <div className="h-px w-2 shrink-0 bg-[#ffffff12]" />}
                    </div>
                  ))}
                </div>
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      ...
                      <p className="mt-3 max-w-sm text-sm leading-7 text-[#a8a29e]">{track.desc}</p>
                    </div>
